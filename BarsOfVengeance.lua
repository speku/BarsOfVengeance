...
local dfs = {
  pwr = {
    pre = {
      IA = {lvl = 2, clr = {0,1,0,1,1}, events = {E_CLEU, E_SUU}}
    },
    gain = {
      IA = {lvl = 4, clr = pwrGainClr, events = {E_UA}},
      BT = {lvl = 5, clr = pwrGainClr, events = {E_UA}},
      Me = {lvl = 3, clr = pwrGainClr, events = {E_UA}}
    },
    current = {
